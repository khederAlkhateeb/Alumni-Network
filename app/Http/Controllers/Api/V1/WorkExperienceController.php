...
class WorkExperienceController extends Controller
{
     ...
     * @return JsonResponse HTTP 201 with the created work experience resource, or HTTP 404 if profile missing.
     */
     ...
     * @return JsonResponse HTTP 200 with updated resource, HTTP 404 if not found/unauthorized, or HTTP 422 on validation failure.
     *
     * @throws ModelNotFoundException If the work experience record is not found or does not belong to the user.
     ...
     * @return JsonResponse HTTP 200 on successful deletion, or HTTP 404 if record/profile not found.
     *
     * @throws ModelNotFoundException If the work experience record is not found or does not belong to the user.
     */
     ...
     *
     * @return AlumniProfile|null The associated profile or null if unauthenticated/unassociated.
     */
    ...
    /**
     * Reusable error response for missing profile.
     *
     * @return JsonResponse HTTP 404 error response structure.
     */
